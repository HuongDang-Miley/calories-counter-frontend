...
const Workout=(props) =>{
    return (
        ...
        <button className="add-workout"onClick={()=>props.addWorkout()}> ADD A WORKOUT</button>
        <br />
        <br />
      ...
      {/* </div> */}
        ...
        <br /><br />
        <input className="type-workout" placeholder="type workout"></input><input className="type-calories"></input>
...
<li>
            ...
            <section className ="workout-calories both">
            {currWork.cal}
