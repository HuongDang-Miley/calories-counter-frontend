...
export default function Sidebar(props) {
    ...
    let totalCalIntake = props.meals.meals
        ...
        .map(meal => meal.food.map(food => food.cal)
            ...
            .reduce((total, foodCal) => { return total += Number(foodCal) }, 0))
        // return total calories of the array
        .reduce((total, mealCal) => { return total += Number(mealCal) }, 0)
    ...
    return (
        <div>
            ...
            <table className='sidebar-table'>
                <thead>
                    <tr>
                        <th className='sidebar-img-cell'><img className='sidebar-img' src='/total-dark-theme.svg' /></th>
                        <th className='sidebar-title-cell'>Total Cal:</th>
                        <th className='sidebar-cal-cell'>{Number(totalCalIntake) - Number(totalCalBurned)}</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td className='sidebar-img-cell'><img className='sidebar-img' src='/meal-dark-theme.svg' /></td>
                ...
                <tbody>
                    <tr>
                        <td className='sidebar-img-cell'><img className='sidebar-img' src='/fire-dark-theme.svg' /></td>
